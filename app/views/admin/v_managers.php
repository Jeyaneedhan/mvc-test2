...
<div class="page-content">
    ...
    if (!empty($data['allManagers'])) {
        ...
        foreach ($data['allManagers'] as $manager) {
            if ($manager->account_status === 'pending') $pendingCount++;
            if ($manager->account_status === 'approved') $approvedCount++;
            if ($manager->account_status === 'rejected') $rejectedCount++;
        }
    }
    ?>
                        ...
                        <tbody id="managers-tbody">
                            <?php if (!empty($data['allManagers'])): ?>
                                <?php foreach ($data['allManagers'] as $manager): ?>
                                    <tr id="manager-row-<?php echo $manager->id; ?>" data-status="<?php echo $manager->account_status; ?>">
                                        ...
                                        <td>
                                            <?php
                                            $statusClass = '';
                                            $statusText = ucfirst($manager->account_status);

                                            switch ($manager->account_status) {
                                                case 'pending':
                                        ...
                                        <td>
                                            <?php if ($manager->account_status === 'pending'): ?>
                                            ...
                                            <?php elseif ($manager->account_status === 'approved'): ?>
                                            ...
                                            <?php elseif ($manager->account_status === 'rejected'): ?>
