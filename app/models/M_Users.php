...
class M_Users
{
    ...
    {
        $this->db->query('SELECT id, name, email, employee_id_filename, employee_id_filetype, 
                     employee_id_filesize, account_status, created_at 
                     FROM Users 
                     ...
                     ORDER BY 
                        CASE 
                            ...
                            WHEN account_status = "rejected" THEN 3
                            ELSE 4
                        END,
                        created_at DESC');
        $this->db->bind(':user_type', 'property_manager');
    ...
    // Add a method to remove/delete a property manager
    ...
    {
        $this->db->query('SELECT id, name, email, user_type, created_at, password 
                      FROM Users 
                      WHERE id = :id');
        $this->db->bind(':id', $id);
